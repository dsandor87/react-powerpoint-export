...
function PowerPoint() {
  function runDemo() {
    ...
    pptx.writeFile({ fileName: "tryout-demo-react.pptx" });
  }
    ...
    <section>
          ...
          <div className="collapse navbar-collapse" id="navbarText">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <a
                  ...
                  aria-current="page"
                  href="https://gitbrent.github.io/PptxGenJS/demo/react/"
                >
                  React Demo Home
                </a>
              </li>
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              <li className="nav-item me-3">
                <a
                  className="nav-link"
                  href="https://gitbrent.github.io/PptxGenJS/demos/"
                >
                  Library Demos
                </a>
              </li>
              <li className="nav-item me-3">
                <a
                  className="nav-link"
                  href="https://gitbrent.github.io/PptxGenJS/docs/installation/"
                >
                  API Documentation
                </a>
              </li>
      ...
      <main className="container">
        <div className="jumbotron my-5">
          ...
          <p className="lead">
            Sample React application to demonstrate using the PptxGenJS library
            as a module.
          </p>
          <hr className="my-4" />
